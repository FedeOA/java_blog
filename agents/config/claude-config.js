...
module.exports = Object.freeze({
  ...
  javaModel: process.env.CLAUDE_JAVA_MODEL || process.env.CLAUDE_MODEL || 'claude-sonnet-4-6',
  ...
  javaMaxTokens: Number(process.env.CLAUDE_JAVA_MAX_TOKENS || process.env.CLAUDE_MAX_TOKENS || 4096),
